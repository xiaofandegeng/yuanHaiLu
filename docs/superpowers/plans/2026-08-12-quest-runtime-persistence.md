...
- [x] **Step 1: Write the failing database and clone tests**
...
- [x] **Step 3: Implement the code-backed quest database**
...
- [x] **Step 4: Implement runtime cloning and ID acceptance**
...
- [x] **Step 1: Write failing v3 round-trip tests**
...
- [x] **Step 3: Implement primitive save DTOs and restore**
...
- [x] **Step 4: Upgrade SaveManager to v3**
...
- [x] **Step 5: Run `QuestPersistenceTests` and existing `PersistenceTests`**
...
- [x] **Step 5: Run integration and runtime tests and verify GREEN**
...
- [x] **Step 3: Implement QuestGiver as a non-IInteractable coordinator**
...
- [x] **Step 4: Delegate from NPCBase**
...
- [x] **Step 2: Run all PlayMode tests**
...
- [x] **Step 3: Run batch compilation/import**
...
- [x] **Step 4: Review the phase diff against `dd2657f`**
...
- [x] **Step 5: Perform Unity Play smoke QA**
